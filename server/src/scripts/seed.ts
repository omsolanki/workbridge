...
const sampleJobs = [
  {
    ...
    description:
      "I need a modern e-commerce website built with React and Node.js. The site should include user authentication, product catalog, shopping cart, and payment integration with Stripe.",
  ...
  },
  {
    ...
    description:
      "Looking for a talented UI/UX designer to create beautiful and intuitive designs for a fitness tracking mobile app. Need wireframes, mockups, and prototypes.",
  ...
  },
  {
    ...
    description:
      "Need help analyzing a large dataset using Python. Looking for someone with experience in pandas, numpy, and matplotlib. The project involves data cleaning, analysis, and visualization.",
  ...
  },
  {
    ...
    description:
      "Looking for ongoing WordPress website maintenance including updates, security monitoring, and content updates. Need someone reliable and experienced.",
    category: "web-development",
...
const sampleProposals = [
  {
    coverLetter:
      "I have extensive experience building e-commerce websites with React and Node.js. I've completed similar projects for multiple clients and can deliver a high-quality, scalable solution within your timeline. I'll ensure the site is responsive, fast, and includes all the features you need.",
    proposedAmount: 4200,
  ...
  {
    coverLetter:
      "As a UI/UX designer with 3+ years of experience, I specialize in creating user-centered designs for mobile applications. I've worked on several fitness apps and understand the unique challenges of this domain. I'll create intuitive, engaging designs that users will love.",
    proposedAmount: 2000,
  ...
  {
    coverLetter:
      "I'm a data scientist with strong Python skills and experience in data analysis. I've worked with similar datasets and can provide comprehensive analysis with clear visualizations. I'll deliver insights that help you make informed decisions.",
    proposedAmount: 1000,
    estimatedDuration: 7,
    attachments: [],
    status: "pending",
...
async function seedDatabase() {
  try {
    ...
    // Get client and freelancer users
    ...
    for (let i = 0; i < sampleProposals.length; i++) {
      ...
      await proposal.save();
      console.log(
        `Created proposal for job: ${job.title} by ${freelancer.username}`
      );
    }
